          ...
          <CardHeader className="bg-[#FDFCFB] border-b border-[#F0EDE6] p-6 md:p-8">
            <div className="flex justify-between items-center mb-4">
                ...
                {[1, 2].map((i) => (
                  <div
                    ...
                    className={cn(
                      ...
                      step === i ? "w-8 bg-[#D4AF97]" : "w-4 bg-border",
                    )}
                  />
                ))}
              </div>
              {step === 2 && (
                <button
                  onClick={prevStep}
                  className="text-[10px] font-bold uppercase tracking-widest text-[#9B9B9B] hover:text-[#D4AF97] flex items-center transition-colors"
                >
            ...
            <CardDescription className="text-xs md:text-sm text-muted-foreground">
              {step === 1
                ? "Tentukan layanan yang paling sesuai dengan kebutuhan Anda."
                : "Lengkapi informasi di bawah untuk aktivasi instan."}
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="p-6 md:p-8 space-y-6">
            {step === 1 ? (
              <div className="space-y-3">
                  ...
                  <div
                    ...
                    className={cn(
                      ...
                      selectedPackage === pkg.name
                        ? "border-[#D4AF97] bg-[#FDFCFB] shadow-md shadow-[#D4AF97]/10"
                        : "border-[#F0EDE6] hover:border-[#D4AF97]/40",
                    )}
                    onClick={() => {
                  ...
                  >
                    <div className="p-4 flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        >
                          {selectedPackage === pkg.name && (
                            <div className="size-1.5 bg-white rounded-full animate-in zoom-in duration-300" />
                          )}
                        </div>
                        <div>
                          <div className="flex items-center gap-2">
                            ...
                            {pkg.popular && (
                              <span className="bg-[#D4AF97] text-white text-[8px] font-black px-2 py-0.5 rounded-full uppercase tracking-tighter italic">
                                Most Popular
                              </span>
                            )}
                          </div>
                          <p className="text-[11px] text-[#9B9B9B] font-medium">
                            {pkg.description}
                          </p>
                        </div>
                      </div>
                    ...
                    >
                      <div className="pt-2 border-t border-[#F0EDE6] grid grid-cols-2 gap-2">
                        {pkg.features.map((feat) => (
                          ...
                          >
                            <CheckCircle2 className="size-2.5 text-[#D4AF97]" />{" "}
                            {feat}
                          </div>
                        ))}
                      </div>
                ...
                <Button
                  onClick={nextStep}
                  className="w-full h-12 mt-4 bg-[#D4AF97] hover:bg-[#B99575] text-white font-bold rounded-xl text-sm transition-all"
                  size="lg"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid gap-4">
                  <div className="space-y-1.5">
                    ...
                    <Input
                      id="nama"
                      placeholder="Aditya Tri Susanto"
                      value={formData.nama}
                      onChange={handleInputChange}
                      required
                      className="h-11 rounded-xl border-[#F0EDE6] focus:border-[#D4AF97] focus:ring-[#D4AF97]/10"
                    />
                  </div>
                  <div className="space-y-1.5">
                    <Label
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      <span className="absolute left-4 top-1/2 -translate-y-1/2 text-xs font-bold text-[#9B9B9B]">
                        +62
                      </span>
                      <Input
                        id="whatsapp"
                        ...
                        className="pl-12 h-11 rounded-xl border-[#F0EDE6]"
                ...
                <div className="bg-[#FDFCFB] border border-[#F0EDE6] p-4 rounded-2xl flex gap-3">
                  ...
                  <p className="text-[11px] leading-relaxed text-muted-foreground font-medium">
                    Sistem akan membuatkan password otomatis untuk paket{" "}
                ...
                <Button
                  type="submit"
                  className="w-full h-12 bg-[#D4AF97] hover:bg-[#B99575] text-white font-bold rounded-xl text-sm transition-all"
                  size="lg"
                >
                  Selesaikan Penregisteran{" "}
