    ...
    <div className="min-h-screen bg-[#F8F5F0] flex items-center justify-center p-6">
      <div className="w-full max-w-[420px] space-y-8">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-[#6B6B6B]">Kelola undangan digital Anda dengan mudah</p>
        </div>

        <Card className="border-[#E5E0D8] shadow-xl">
          <CardHeader className="space-y-1 pb-6 text-center">
            <CardTitle className="text-2xl font-semibold text-[#2C2C2C]">Selamat Datang Kembali</CardTitle>
          ...
          <CardContent className="space-y-6">
            <form className="space-y-4">
              ...
              {/* Submit Button */}
              <Button className="w-full h-11 text-base mt-2" size="default">
            ...
            <div className="text-center">
              <p className="text-sm text-[#6B6B6B]">
                Belum memiliki akun?{" "}
                <Link href="/daftar" className="text-[#D4AF97] font-semibold hover:underline">
                  Daftar di sini
                </Link>
              </p>
            </div>
        ...
        <p className="text-center text-xs text-[#6B6B6B]">
          &copy; {new Date().getFullYear()} Undang Dong. Semua hak cipta dilindungi.
        </p>
      </div>
    </div>
  )
