...
interface RSVP {
  id: string;
  guestName: string;
  guestPhone: string | null; // Gunakan null, bukan undefined
  attendance: string; // Bisa diperjelas jika perlu
...
interface Template {
  ...
  name: string;
  slug: string;
  description: string | null; // Database sering mengembalikan null untuk kolom optional
  thumbnail: string;
  isPremium: boolean;
}
