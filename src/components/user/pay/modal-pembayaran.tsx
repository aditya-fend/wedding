          ...
          <div className="bg-[#FDFCFB] border-b border-[#F0EDE6] p-6 text-center">
            ...
            <DialogHeader className="p-0 space-y-2">
              ...
              <DialogDescription className="text-xs md:text-sm text-[#6B6B6B] leading-relaxed">
                Akun anda telah terregister. Silakan selesaikan pembayaran paket{" "}
                <span className="font-bold text-[#2C2C2C]">
                  {userData.package}
                </span>{" "}
                untuk aktivasi fitur.
              </DialogDescription>
            </DialogHeader>
          </div>
          ...
          <div className="p-6 md:p-8 flex flex-col items-center">
              ...
              <div className="relative bg-white border-[6px] border-[#F0EDE6] rounded-[2rem] p-3 shadow-sm overflow-hidden">
                <div className="flex items-center justify-between mb-2 px-1">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[9px] font-black tracking-widest text-[#2C2C2C]">
                      QRIS PROCESSED
                    </span>
                  </div>
            ...
            <div className="mt-8 w-full space-y-4">
              <div className="flex items-start gap-3 p-3 rounded-xl bg-[#FDFCFB] border border-[#F0EDE6]">
                <div className="size-5 rounded-full bg-[#D4AF97] text-white flex items-center justify-center text-[10px] font-bold shrink-0 mt-0.5">
                  1
                </div>
              ...
              <div className="flex items-start gap-3 p-3 rounded-xl bg-[#FDFCFB] border border-[#F0EDE6]">
                ...
                <p className="text-[11px] md:text-xs text-[#6B6B6B] leading-relaxed">
                  Klik tombol <strong>Kirim Bukti</strong> di bawah. Lampirkan
                  screenshot transaksi dan admin akan mengaktivasi akun Anda.
                </p>
              </div>
            </div>
