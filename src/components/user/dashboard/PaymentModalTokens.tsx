...
import { MessageCircle, ArrowLeft, CheckCircle2, ShieldCheck, QrCode } from "lucide-react";
...
export function PaymentModalTokens({
  ...
  const handleWhatsAppChat = () => {
    ...
    const message =
      `Halo Admin SajiJanji, saya telah melakukan pembayaran.\n\n` +
          ...
          <div className="flex flex-col items-center gap-8 py-2">
            ...
            <div className="w-full bg-[#FDFCFB] border border-[#F0EDE6] rounded-[2rem] p-6 relative overflow-hidden group">
              ...
              <div className="flex flex-col items-center relative z-10">
                ...
                <div className="flex items-baseline gap-2">
                  <span className="text-5xl font-black text-[#2C2C2C] tracking-tighter">{tokenAmount}</span>
                  <span className="text-xs font-black text-[#D4AF97] uppercase tracking-widest">Tokens</span>
                </div>
            ...
            <div className="text-center space-y-3 px-2">
              ...
              <p className="text-xs text-[#6B6B6B] leading-relaxed font-medium">
                1. Scan QRIS di atas melalui aplikasi Mobile Banking/E-Wallet.<br/>
                2. Simpan bukti transfer Anda.<br/>
                3. Klik tombol hijau di bawah untuk konfirmasi ke Admin.<br/>
                <span className="text-[10px] mt-2 block italic opacity-70">*Token akan masuk secara otomatis setelah divalidasi.</span>
              </p>
            </div>
          </div>

          <DialogFooter className="flex flex-col gap-3 mt-8 pt-6 border-t border-[#F0EDE6]">
            <Button
