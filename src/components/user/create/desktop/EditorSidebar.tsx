...
export function EditorSidebar({ templates, musics }: SidebarProps) {
  ...
  return (
    <aside
      className="flex flex-col h-screen w-full shrink-0 border-r border-[#E5E0D8]"
            ...
            <DialogTrigger asChild>
              <button className="group flex w-full items-center justify-between rounded-3xl border border-slate-200 bg-white p-4 text-left shadow-sm transition hover:border-[#D4AF97] hover:bg-[#FDFCFB]">
                <div className="flex-1">
                  ...
                  <h3 className="mt-1 text-sm font-bold text-[#2C2C2C]">
            ...
            <DialogContent className="!max-w-5xl w-[95vw] h-[90vh] flex flex-col rounded-[32px] border-none shadow-2xl p-0 bg-[#FDFCFB] overflow-hidden">
              ...
              <DialogHeader className="p-8 pb-4 bg-white/70 backdrop-blur-md border-b border-slate-100 shrink-0">
                ...
                <DialogDescription className="text-slate-500 font-medium">
                  Pilih desain yang mencerminkan karakter unik hari bahagia
                  Anda.
                </DialogDescription>
              </DialogHeader>
            ...
            <DialogTrigger asChild>
              <button className="group flex w-full items-center justify-between rounded-3xl border border-slate-200 bg-white p-4 text-left shadow-sm transition hover:border-[#D4AF97]">
                <div className="flex-1">
                  ...
                  <h3 className="mt-1 text-sm font-bold text-[#2C2C2C] truncate">
                    {selectedMusic?.title ?? "Tanpa Musik"}
                  </h3>
                </div>
                  ...
                  >
                    <button
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        setPlayingMusicId(
                          playingMusicId === music.id ? null : music.id,
                        );
                      }}
                    >
        ...
        >
          <div className="space-y-4">
            <div
              ...
              onDragOver={(e) => {
                e.preventDefault();
                setDragStates((prev) => ({ ...prev, pria: true }));
              }}
              onDragLeave={() =>
              ...
              onDrop={(e) => {
                e.preventDefault();
                setDragStates((prev) => ({ ...prev, pria: false }));
                handleFileUpload(e.dataTransfer.files?.[0], (url) =>
              ...
              onClick={() => {
                ...
                input.onchange = (e) =>
                  handleFileUpload(
                    ...
                    (url) => updateField("mempelai_pria", "foto", url),
                  );
                input.click();
              }}
            >
            ...
            <div
              ...
              onClick={() => {
                ...
                input.onchange = (e) =>
                  handleFileUpload(
                    (e.target as HTMLInputElement).files?.[0],
                    (url) => updateField("mempelai_wanita", "foto", url),
                  );
                input.click();
              }}
            >
            ...
            <div
              ...
              onClick={() => {
                ...
                input.onchange = (e) =>
                  handleFileUpload(
                    (e.target as HTMLInputElement).files?.[0],
                    (url) => setFormData({ hero_image: url }),
                  );
                input.click();
              }}
            >
              {formData.hero_image ? (
                ...
                <p className="text-[10px] font-bold text-slate-400 uppercase text-center px-4">
                  Hero Image (Landscape disarankan)
                </p>
              )}
            </div>
            <Input
        ...
        >
          <div className="space-y-4">
            ...
            {formData.acara?.map((event, idx) => (
              <div
                key={idx}
                className="p-4 rounded-2xl bg-white border border-slate-100 relative group shadow-sm"
              >
                <button
                ...
                <div className="space-y-3">
                  <Input
                    placeholder="Nama Sesi (e.g. Akad)"
                    value={event.tipe}
                    onChange={(e) =>
                  ...
                  />
                  <Input
                    placeholder="Waktu (e.g. 09:00 - Selesai)"
                    value={event.jam}
                    onChange={(e) =>
            ...
            <Button
              variant="outline"
              className="w-full border-dashed rounded-xl text-[#D4AF97]"
              onClick={() =>
                addArrayItem("acara", {
                  tipe: "",
                  jam: "",
            ...
            <Button
              className="w-full bg-[#2C2C2C] text-white rounded-xl text-xs font-bold h-10"
        ...
        >
          <div className="space-y-4">
            {formData.love_story?.map((story, idx) => (
              <div
                key={idx}
                className="p-4 rounded-2xl bg-white border border-slate-100 space-y-3 relative shadow-sm"
              >
                <Input
                  placeholder="Tahun"
                  value={story.tahun}
                  onChange={(e) =>
                    updateArrayField("love_story", idx, "tahun", e.target.value)
                  }
                  className="h-8 text-xs font-bold"
                />
                <Textarea
            ...
            <Button
              variant="ghost"
              className="w-full text-[#D4AF97] hover:bg-[#D4AF97]/5"
              onClick={() =>
                addArrayItem("love_story", { tahun: "", cerita: "", foto: "" })
              }
            >
            ...
            <button
              ...
              onClick={() => {
                ...
                input.onchange = (e) => {
                  ...
                  setFormData({
                    gallery: [...(formData.gallery || []), ...urls].slice(
                      0,
                      12,
                    ),
                  });
        ...
        >
          <div className="space-y-4">
            {formData.digital_envelope?.map((env, idx) => (
              <div
                key={idx}
                className="p-4 rounded-2xl bg-[#FDFCFB] border border-slate-100 space-y-2 relative shadow-sm"
              >
                <Input
